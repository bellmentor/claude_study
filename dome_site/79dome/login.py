...
LOGIN_URL = "https://79dome.com/bbs/login.php"
SITE_LABEL = "친구도매"
...
async def login() -> bool:
    """친구도매에 로그인한다. 모듈 세션을 재사용하며 종료하지 않는다. 성공 여부 반환."""
    ...
    await page.fill("#mb_id", user)
    await page.fill("#mb_password", pw)
